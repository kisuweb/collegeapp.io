...
public class AboutWindow extends JFrame {
	...
	private AboutWindow() {
		...
		JLabel lblLink = new JLabel("http://pp.com");
		...
		lblLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("http://www.pp.com"));
                } catch (Exception ex) {
                	ex.printStackTrace();
                }
            }
		...
		// label "title"
		JLabel lblTitle = new JLabel("Currencyy Converter");
		...
		// label "licence"
		JLabel lblLicenceMit = new JLabel("Licence 1.2.3");
